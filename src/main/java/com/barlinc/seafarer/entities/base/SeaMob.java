...
public abstract class SeaMob extends WaterAnimal {
    ...
    public SeaMob(EntityType<? extends SeaMob> entityType, Level level) {
    ...
    public static boolean canSpawn(EntityType<? extends SeaMob> entityType, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
